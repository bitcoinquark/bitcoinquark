...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = strprintf(_("%s bitcoinquark-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinquark-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinquark transaction") + "\n" +
              "  bitcoinquark-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinquark transaction") + "\n" +
              "\n";
