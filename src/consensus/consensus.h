...
static const unsigned int DEFAULT_MAX_BLOCK_SIZE = SCALE_FACTOR * ONE_MEGABYTE;
...
static const unsigned int MAX_BLOCK_SERIALIZED_SIZE = WITNESS_SCALE_FACTOR * DEFAULT_MAX_BLOCK_SIZE;
/** The maximum allowed weight for a block, see BIP 141 (network rule) */
static const unsigned int MAX_BLOCK_WEIGHT = WITNESS_SCALE_FACTOR * DEFAULT_MAX_BLOCK_SIZE;
/** The maximum allowed number of signature check operations in a block (network rule) */
static const int64_t MAX_BLOCK_SIGOPS_COST = WITNESS_SCALE_FACTOR * MAX_BLOCK_SIGOPS;
