...
struct Params {
    ...
    int BIP66Height;
    /** Block height at which BitcoinQuark hard fork becomes active */
    int BTQHeight;
    /** Premining blocks for BitcoinQuark hard fork */
    int BTQPremineWindow;
    bool BTQPremineEnforceWhitelist;
    /**
