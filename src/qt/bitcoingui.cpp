...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoinquark: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a bitcoinquark: URI or payment request"));
