...
Also test that nodes that send unsupported service bits to bitcoinquarkd are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if bitcoinquarkd ban behavior changes
    def on_open(self):
        super().on_open()
